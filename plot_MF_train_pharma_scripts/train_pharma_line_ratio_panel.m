...
all_line_plot_par = {{all_train_slow_amp_pharma{1}{2}...
    ./all_train_slow_amp_pharma{1}{6}}};
all_ylabels = {'Baseline\newline20 / 60 amplitude ratio'};
...
hold on
plot(line_ax{ax_idx}.XLim,[20/60,20/60],'Color',[0.5 0.5 0.5],'LineStyle','--');
%Add legend
